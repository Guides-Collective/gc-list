...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-OUTUYJE6.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
  }
...
var resolveResponse = () => __awaiter5(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-ponyfill-OUTUYJE6.js")).Response;
  }
  return Response;
});
...
var resolveFetch4 = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = async (...args) => await (await import("./browser-ponyfill-OUTUYJE6.js")).fetch(...args);
  } else {
    _fetch = fetch;
  }
  return (...args) => _fetch(...args);
